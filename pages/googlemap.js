...
const Map = () => {
    ...
    return (
        <div className='absolute top-24'>
            <iframe src={`https://maps.google.com/maps?q=${lat},${lon}&z=15&output=embed`} style={{ border: "0" }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className='mx-auto w-[100vw] md:h-[60vh] h-[40vh]'></iframe>

            <form action="" className='md:w-1/2 w-full my-3  mx-auto py-6 px-8 bg-slate-50 rounded-sm' style={{ fontFamily: 'PT Sans Narrow' }} onSubmit={handleSubmit((onSubmit))}>
